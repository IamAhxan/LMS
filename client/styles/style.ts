export const styles = {
    ...
    button: "flex flex-row justify-center items-center py-3 px-6 rounded-full cursor-pointer bg-[#2190ff] min-h-[45px] w-full text-[16px] font-Poppins font-semibold text-black dark:text-white hover:bg-[#0b76e5] transition-all duration-300 ease-in-out",
